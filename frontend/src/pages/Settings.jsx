...
const Settings = () => {
  ...
  const [selectedLevel, setSelectedLevel] = useState(profile?.level._id || "");
  ...
  return (
    <div className="md:p-4 w-full lg:w-[75%] lg:mx-auto rounded-lg">
      ...
      <div className="text-xl border dark:border-third p-4 rounded-xl">
        ...
        <label className="font-bold dark:text-white text-gray-700">
          {t("settings.educationalCurriculum")}
        </label>
        <div className="mb-6">
          <label className="font-semibold dark:text-white text-gray-700">
            {t("settings.level")}
          </label>
          <select
            value={selectedLevel}
